...
// Middlewares
app.use(morgan("dev"));
app.use(express.urlencoded({ extended: false }));//Para poder aceptar desde los formularios los datos que envian los usuarios, extended: false acepta solo datos string
    ...
    try {
        if (req.user.ROL_ID) {
            if (req.user.ROL_ID == 1) {
                ...
                app.locals.partner = false;
            } else if (req.user.ROL_ID == 2) {
                app.locals.partner = true;
